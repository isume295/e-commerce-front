                ...
                <div className="flex border bg-white rounded-lg shadow-lg mx-auto max-w-sm lg:max-w-4xl">
                    ...
                    <div className="w-full p-8 lg:w-1/2">
                        ...
                        <a href="#i" className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                            ...
                            <h1 className="lg:px-14 p-4 py-3 w-5/6 text-gray-600 font-bold">Sign up with Google</h1>
                        </a>
                            ...
                            <Form>
                                ...
                                <div className="mt-4">
                                    <Field
                                        ...
                                        className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                                    />
                                    <ErrorMessage name="confirm" component="div" className="text-red-500  flex items-start" />
                                </div>
                                <div className="mt-8">
